...
<html lang="en">
  <head>
    ...
    <title>盤後資料 - 外資個股買賣超前30名 - 0055元大MSCI金融</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="clearfix"></div>
                  <div class="x_content">
                  	<h3>外資買賣超 - <strong>集中市場 / 買超排行</strong> 日期：2017/3/28</h3>
                    <div class="table-responsive">
                      <table class="table StackTable" id="function_20">
                        <thead>
                          <tr>
                            <th>名次</th>
                            <th>代碼</th>
                  ...
                  <div class="x_content">
                  	<h3>外資買賣超 - <strong>集中市場 / 賣超排行</strong> 日期：2017/3/28 </h3>
                    <div class="table-responsive">
                      <table class="table StackTable" id="function_20_2">
                        <thead>
                          <tr>
                            <th>名次</th>
                            <th>代碼</th>
