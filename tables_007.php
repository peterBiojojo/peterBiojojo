...
<html lang="en">
  <head>
    ...
    <title>盤後資料 - 持股轉讓 - 0055元大MSCI金融</title>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="table-responsive">
                      <table class="table StackTable" id="function_07">
                          <thead>
                              <tr>
                                <th>項次</th>
                                <th>申報日期</th>
                          ...
                          <tbody>
                              <tr>
                                ...
                                <td class="date">20170203</td>
                                <td>法人董事代表人配偶</td>
                                <td>王文潮之配偶</td>
                                <td>一般交易</td>
                                <td></td>
                                <td class="nums">41,401,000</td>
                                <td class="nums">3,601,000</td>
                                <td class="nums">37,800,000</td>
                                <td class="nums"></td>
                              </tr>
                              <tr>
                                <td class="idCode">2</td>
                                <td class="date">20130614</td>
                                <td>董事</td>
                                <td>新光醫療財團法人</td>
                                <td>盤後定價交易</td>
                                <td>　</td>
                                <td class="nums">20,009,905</td>
                                <td class="nums">4,000,000</td>
                                <td class="nums">16,009,905</td>
                                <td class="nums">　</td>
                              </tr>
                              <tr>
