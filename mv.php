              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel x_panel_2">
                    <div class="page-title">
                      <div>
                        <h3>Uranus Tutorial Series Episode 1: Introduction</h3>
                      </div>
                    </div>
                    <div class="yt-container">
                    	<iframe src="https://www.youtube.com/embed/NT2jPGIrw-0" frameborder="0" allowfullscreen></iframe>
                    </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel x_panel_2">
                    <div class="page-title">
                      <div>
                        <h3>Uranus Tutorial Series Episode 2: introduction to learning with templates</h3>
                      </div>
                    </div>
                    <div class="yt-container">
                    	<iframe src="https://www.youtube.com/embed/e6iHHyXBzGs" frameborder="0" allowfullscreen></iframe>
                    </div>
                    <div class="clearfix mart20"></div>
                </div>
              </div>
