    ...
    window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
        ...
        var h, u, _, p, f, c, d = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
            ...
            $ = function(t, e) {
                ...
                if (e = e || W(t, null))
                    ...
                    for (i in e) r[i.replace(S, R)] = e[i];
        ...
        var he = function(t, e, i, s) {
            ...
            fe = a.parseComplex = function(t, e, i, s, r, n, a, o, l, u) {
                ...
                var _, p, f, c, g, v, y, T, w, x, P, S, k = i.split(", ").join(",").split(" "),
                ...
                for ((-1 !== s.indexOf(",") || -1 !== i.indexOf(",")) && (k = k.join(" ").replace(D, ", ").split(" "), R = R.join(" ").replace(D, ", ").split(" "), C = k.length), C !== R.length && (k = (n || "").split(" "), C = k.length), a.plugin = l, a.setRatio = u, _ = 0; C > _; _++)
                    if (c = k[_], g = R[_], T = parseFloat(c), T || 0 === T) a.appendXtra("", T, ie(g, T), g.replace(m, ""), O && -1 !== g.indexOf("px"), !0);
                    ...
                    for (f = 0, p = 0; v.length > p; p++) P = v[p], x = c.indexOf(P, f), a.appendXtra(c.substr(f, x - f), Number(P), ie(y[p], P), "", O && "px" === c.substr(x + P.length, 2), 0 === p), f = x + P.length;
                    a["xs" + a.l] += c.substr(f)
        ...
        var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(","),
            ...
            be = function(t, e, i, s) {
                ...
                for (ye ? r = Q(t, Te, e, !0) : t.currentStyle && (r = t.currentStyle.filter.match(O), r = r && 4 === r.length ? [r[0].substr(4), Number(r[2].substr(4)), Number(r[1].substr(4)), r[3].substr(4), v.x || 0, v.y || 0].join(",") : ""), n = (r || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], o = n.length; --o > -1;) l = Number(n[o]), n[o] = (h = l - (l |= 0)) ? (0 | h * w + (0 > h ? -.5 : .5)) / w + l : l;
                if (16 === n.length) {
                    var S = n[8],
                        k = n[9],
                        R = n[10],
            ...
            Se = function() {
                var t, e, i, s, r, n, a, o, l, h, u, _, f, c, d, m, g, v, y, T, w, x, b, P, S, k, R = this.data,
                    ...
                    M = R.scaleZ,
                    L = R.perspective;
                if (p && (P = C.top ? "top" : C.bottom ? "bottom" : parseFloat(Q(this.t, "top", null, !1)) ? "bottom" : "top", T = Q(this.t, P, null, !1), S = parseFloat(T) || 0, k = T.substr((S + "").length) || "px", R._ffFix = !R._ffFix, C[P] = (R._ffFix ? S + .05 : S - .05) + k), O || R.skewX) v = Math.cos(O), y = Math.sin(O), t = v, r = y, R.skewX && (O -= R.skewX, v = Math.cos(O), y = Math.sin(O)), e = -y, n = v;
                else {
                    if (!(R.rotationY || R.rotationX || 1 !== M || L)) return C[ye] = "translate3d(" + R.x + "px," + R.y + "px," + R.z + "px)" + (1 !== A || 1 !== D ? " scale(" + A + "," + D + ")" : ""), void 0;
                    t = n = 1, e = r = 0
                }
        ...
        me("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D", {
            parser: function(t, e, i, s, n, a, o) {
                ...
                for (null != y.force3D && (d.force3D = y.force3D, f = !0), p = d.force3D || d.z || d.rotationX || d.rotationY || l.z || l.rotationX || l.rotationY || l.perspective, p || null == y.scale || (l.scaleZ = 1); --v > -1;) i = ve[v], _ = l[i] - d[i], (_ > g || -g > _ || null != I[i]) && (f = !0, n = new pe(d, i, d[i], _, n), i in T && (n.e = T[i]), n.xs0 = 0, n.plugin = a, s._overwriteProps.push(n.n));
            ...
            parser: function(t, e, i, n, a) {
                e = this.format(e);
                var o, l, h, u, _, p, f, c, d, m, g, v, y, T, w, x, b = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                    P = t.style;
        ...
        l = a.prototype, l._firstPT = null, l._onInitTween = function(t, e, o) {
            ...
            if (u && "" === x.zIndex && (l = Q(t, "zIndex", r), ("auto" === l || "" === l) && (x.zIndex = 0)), "string" == typeof e && (d = x.cssText, l = $(t, r), x.cssText = d + ";" + e, l = G(t, l, $(t)).difs, !z && w.test(e) && (l.opacity = parseFloat(RegExp.$1)), e = l, x.cssText = d), this._firstPT = p = this.parse(t, e, null), this._transformType) {
                for (T = 3 === this._transformType, ye ? _ && (u = !0, "" === x.zIndex && (v = Q(t, "zIndex", r), ("auto" === v || "" === v) && (x.zIndex = 0)), f && (x.WebkitBackfaceVisibility = this._vars.WebkitBackfaceVisibility || (T ? "visible" : "hidden"))) : x.zoom = 1, c = p; c && c._next;) c = c._next;
