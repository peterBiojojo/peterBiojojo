var theme = {
      ...
      echartBarLine.setOption({
        ...
        xAxis: [{
          type: 'category',
          data: ['20170307','20170310','20170318','20170320','20170322','20170325','20170327']
        }],
        yAxis: [{
          type: 'value',
          name: '百張',
        ...
        series: [{
          ...
          type: 'bar',
		  stack:'三大法人',
          data: [ 3.2,1.2,3.0,4.5,2.2,-1.8,2.8]
        }, {
          name: '投信',
          type: 'bar',
		  stack:'三大法人',
          data: [1.0,2.9,0.4,-3.5,1.3,-0.9,-1.9]
        },  {
          name: '自營商',
          type: 'bar',
		  stack:'三大法人',
          data: [-0.5,-3,-3,1,-1,-2.5,-0.2]
        },  {
          name: '股價(成交價)',
          type: 'line',
          yAxisIndex: 1,
