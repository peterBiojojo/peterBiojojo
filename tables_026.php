...
<html lang="en">
  <head>
    ...
    <title>盤後資料 - 資減個股排行 - 0055元大MSCI金融</title>
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                    <div class="page-title">
                      <div class="title_left">
                        <h3>資減個股排行<div class="clearfix"></div><cite class="downer-Numbers">(單位：張)</cite></h3>
                      </div>
                  ...
                  <div class="x_content">
                  	<h3>融資減少排行 - <strong>集中市場 / 前30 / 全部</strong> 日期：2017/3/28 </h3>
                    <div class="table-responsive">
                      <table class="table StackTable" id="function_26">
                        <thead>
                          <tr>
                            <th>名次</th>
                            <th>代碼</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="nums">-1230</td>
                            <td class="nums">7,692</td>
                            <td class="nums">-206</td>
                            <td class="nums">206</td>
                            <td class="nums green">- 1,024</td>
                          ...
                          <tr>
                            ...
                            <td class="nums">-1052</td>
                            <td class="nums">5,228</td>
                            <td class="nums">5</td>
                            <td class="nums">5</td>
                            <td class="nums">- 1,057</td>
    ...
    <script src="js/candlestickchart/js/chart_15.js"></script>
  </body>
</html>