...
<html lang="en">
  <head>
    ...
    <title>盤後資料 - 自營商個股買賣超前30名 - 0055元大MSCI金融</title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                        ...
                        <div class="well">
                          <form class="form-horizontal">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-12 marTop_20">
                    ...
                    <div class="clearfix"></div>
                  <div class="x_content">
                  	<h3>自營商買賣超 - <strong>集中市場 / 買超排行</strong> 日期：2017/3/28</h3>
                    <div class="table-responsive">
                      <table class="table StackTable" id="function_22">
                        <thead>
                          <tr>
                            <th>名次</th>
                            <th>代碼</th>
                  ...
                  <div class="x_content">
                  	<h3>自營商買賣超 - <strong>集中市場 / 賣超排行</strong> 日期：2017/3/28</h3>
                    <div class="table-responsive">
                      <table class="table StackTable" id="function_22_2">
                        <thead>
                          <tr>
                            <th>名次</th>
                            <th>代碼</th>
