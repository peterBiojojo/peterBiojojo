...
<html lang="en">
  <head>
    ...
    <title>盤後資料 - 除權除息總表 - 0055元大MSCI金融</title>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive">
                      <table class="table StackTable" id="function_37">
                          <thead>
                              <tr>
                                <th>項次</th>
                                <th>公司代碼</th>
                          ...
                          <tr>
                            ...
                            <td class="nums">74.2</td>
                            <td class="nums">58.8</td>
                            <td class="nums">39.5</td>
                            <td class="nums">39.5</td>
                            <td class="nums">98.1</td>
                            <td class="date">20160420</td>
                            <td class="date">20160420</td>
                          </tr>
                          <tr>
