...
<html lang="en">
  <head>
    ...
    <title>盤後資料 - 營益比率 - 0055元大MSCI金融</title>
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                    <div class="page-title">
                      <div class="title_left">
                        <h3>營益比率<div class="clearfix"></div><cite class="downer-Numbers">(單位：仟元)</cite></h3>
                      </div>
                  ...
                  <div class="x_content">
                    <div class="table-responsive">
                      <table class="table StackTable" id="function_13">
                          <thead>
                              <tr>
                                <th>年/季</th>
                                <th>季營收</th>
                          ...
                          <tbody>
                              <tr>
                                <td class="date">2016/Q4</td>
                                <td class="nums">78,112,016</td>
                                <td class="nums red">11.69</td>
                                <td class="nums red">3.35</td>
                                <td class="nums red">5.81</td>
                                <td class="nums green">-0.27</td>
                              </tr>
                              <tr>
                                <td class="date">2016/Q3</td>
                                <td class="nums">93,029,912</td>
                                <td class="nums red">11.31</td>
                                <td class="nums green">-1.29</td>
                                <td class="nums green">-9.00</td>
                                <td class="nums green">-11.80</td>
                              </tr>
                              <tr>
                                <td class="date">2016/Q2</td>
                                <td class="nums">91,085,320</td>
                                <td class="nums red">16.39</td>
                                <td class="nums red">0.43</td>
                                <td class="nums red">2.91</td>
                                <td class="nums red">2.39</td>
                              </tr>
                              <tr>
                                <td class="date">2016/Q1</td>
                                <td class="nums">89,702,808</td>
                                <td class="nums red">17.17</td>
                                <td class="nums green">-0.79</td>
                                <td class="nums red">2.72</td>
                                <td class="nums red">0.98</td>
                              </tr>
                              <tr>
                                <td class="date">2015/Q4</td>
                                <td class="nums">94,311,424</td>
                                <td class="nums red">18.46</td>
                                <td class="nums red">1.28</td>
                                <td class="nums red">3.20</td>
                                <td class="nums green">-8.11</td>
                              </tr>
                              <tr>
                                <td class="date">2015/Q3</td>
                                <td class="nums">76,391,664</td>
                                <td class="nums red">18.58</td>
                                <td class="nums red">0.27</td>
                                <td class="nums green">-0.14</td>
                                <td class="nums green">-0.11</td>
                              </tr>
                              <tr>
                                <td class="date">2015/Q2</td>
                                <td class="nums">81,390,752</td>
                                <td class="nums red">18.85</td>
                                <td class="nums red">1.48</td>
                                <td class="nums red">4.02</td>
                                <td class="nums red">3.36</td>
                              </tr>
                              <tr>
                                <td class="date">2015/Q1</td>
                                <td class="nums">73,575,776</td>
                                <td class="nums red">25.48</td>
                                <td class="nums red">5.62</td>
                                <td class="nums green">-9.16</td>
                                <td class="nums green">-3.04</td>
                              </tr>
                              <tr>
                                <td class="date">2014/Q4</td>
                                <td class="nums">66,843,312</td>
                                <td class="nums">18.67</td>
                                <td class="nums green">-0.53</td>
                                <td class="nums">0.51</td>
                                <td class="nums green">-4.19</td>
                              </tr>
                              <tr>
                                <td class="date">2014/Q3</td>
                                <td class="nums">73,088,808</td>
                                <td class="nums red">15.80</td>
                                <td class="nums green">-3.36</td>
                                <td class="nums green">-4.45</td>
                                <td class="nums green">-8.68</td>
                              </tr>
                              <tr>
                                <td class="date">2014/Q2</td>
                                <td class="nums">59,551,320</td>
                                <td class="nums red">20.77</td>
                                <td class="nums green">-6.82</td>
                                <td class="nums red">31.86</td>
                                <td class="nums red">32.19</td>
                              </tr>
                              <tr>
                                <td class="date">2014/Q1</td>
                                <td class="nums">70,855,232</td>
                                <td class="nums green">-36.90</td>
                                <td class="nums green">-12.10</td>
                                <td class="nums green">-76.58</td>
                                <td class="nums green">-76.73</td>
                              </tr>
                          </tbody>
                        </table>
                    </div>
    ...
    <script src="js/candlestickchart/js/chart_05.js"></script>
  </body>
</html>