...
<html lang="en">
  <head>
    ...
    <title>盤後資料 - 公司資料 - 0055元大MSCI金融</title>
                      ...
                      <div class="title_right">
                        <div class="col-md-8 col-sm-8 col-xs-12 form-group pull-right top_search">
                          <div class="input-group">
                            <input type="text" class="form-control" placeholder="股票代碼/關鍵字">
                  ...
                  <div class="x_content">
                      <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <table class="table">
                              <tr>
                                <th class="text-center col-xs-3">時間</th>
                                <td class="text-center col-xs-9">標題</td>
                              </tr>
                              <tr>
                                <td class="text-center">03-23 <cite class="second">14:02</cite></td>
                                <td><a href="tables_002Article.php">台塑擬配息4.6元 三寶現金殖利率均超過5%</a></td>
                              </tr>
                              <tr>
                                <td class="text-center">03-23 <cite class="second">14:02</cite></td>
                                <td><a href="tables_002Article.php">台塑擬配息4.6元 三寶現金殖利率均超過5%</a></td>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 marTop_20">
                        	<h4>即時新聞</h4>
                            <table class="table">
                              <tr>
                                <th class="text-center col-xs-3">時間</th>
