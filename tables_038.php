...
<html lang="en">
  <head>
    ...
    <title>盤後資料 - 股東會總表 - 0055元大MSCI金融</title>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive">
                      <table class="table StackTable" id="function_38">
                          <thead>
                              <tr>
                                <th>項次</th>
                                <th>公司代碼</th>
                          ...
                          <tbody>
                              <tr>
                                ...
                                <td>台塑</td>
                                <td class="date">20160420</td>
                                <td>台北市敦化北路100號王朝大酒店2樓國際大會堂</td>
                                <td class="date">20160419-20160419</td>
                                <td class="date">20160420</td>
                                <td>常會</td>
                                <td class="idCode">是</td>
                              </tr>
                              <tr>
